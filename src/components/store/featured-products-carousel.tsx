        ...
        >
          {products.map((product) => (
            ...
            >
              ...
              <div className="relative grid min-h-[11rem] grid-cols-[1fr_1fr] gap-2 px-3 py-2 md:min-h-[16rem] md:grid-cols-[0.94fr_1.06fr] md:items-center md:gap-0 md:p-5">
                ...
                <div className="relative flex items-center justify-end">
                  ...
                  <img
                    ...
                    alt={product.name}
                    className="relative z-10 h-36 w-full object-contain drop-shadow-[0_20px_28px_rgba(8,3,23,0.42)] transition duration-500 group-hover:scale-[1.05] group-hover:-rotate-1 md:h-56 md:drop-shadow-[0_24px_34px_rgba(8,3,23,0.44)]"
                  />
                </div>
              </div>
