  ...
  return (
    <section className="app-page quote-print-root px-0 pb-8 pt-1 md:px-7 md:pb-12 md:pt-2">
      <div className="quote-print-stack flex w-full flex-col gap-5 md:gap-6">
        <section className="quote-print-card quote-print-hero relative overflow-hidden rounded-2xl border border-white/55 bg-gradient-to-br from-slate-900 via-blue-900 to-teal-700 p-2.5 shadow-2xl md:p-4">
          ...
          <div className="quote-print-hero-layout relative grid gap-3 lg:grid-cols-[minmax(0,1fr)_17rem]">
            <div className="quote-print-hero-main space-y-2">
              <div className="quote-print-hero-header flex items-start justify-between gap-2">
                <div className="inline-flex items-center gap-2 px-0 py-0">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-sky-100/80">NIT {companyInfo.nit}</p>
                  </div>
                </div>
              ...
              <div className="quote-print-panel quote-print-client-panel rounded-2xl border border-white/28 bg-white/14 p-2.5 backdrop-blur-md md:p-3">
                <p className="text-xs uppercase tracking-widest text-sky-100/80">Datos cliente</p>
                <p className="mt-0.5 text-base font-semibold tracking-tight text-white md:text-lg">{quote.client.name || "Por confirmar"}</p>
                <div className="quote-print-mobile mt-2 grid grid-cols-2 gap-x-3 gap-y-1.5 text-xs text-sky-100 md:hidden">
            ...
            <aside className="quote-print-panel quote-print-company-panel rounded-2xl border border-white/28 bg-white/15 p-2.5 backdrop-blur-md md:p-3">
              <p className="text-xs uppercase tracking-widest text-sky-100/80">Datos de empresa</p>
              <p className="mt-0.5 text-base font-semibold tracking-tight text-white md:text-lg">{quote.code}</p>
              <div className="quote-print-company-desktop mt-2 grid grid-cols-2 gap-x-3 gap-y-1.5 text-xs text-sky-100 md:block md:space-y-2 md:text-sm">
        ...
        <div className="space-y-2">
          <section className="quote-print-card overflow-hidden rounded-2xl border border-slate-200/85 bg-white/92 shadow-sm backdrop-blur-sm">
          ...
          <section className="quote-print-card overflow-hidden rounded-2xl border border-slate-200/85 bg-white/92 shadow-sm backdrop-blur-sm">
            <div className="quote-print-mobile grid grid-cols-2 gap-2 p-3 md:hidden">
              ...
              <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
                <p className="text-xs uppercase tracking-widest text-slate-500">Valor adicional</p>
              ...
              <div className="rounded-xl border border-slate-300 bg-slate-100 px-3 py-2">
                <p className="text-xs uppercase tracking-widest text-slate-600">Valor total</p>
        ...
        <section className="quote-print-card rounded-2xl border border-slate-200/85 bg-white/92 p-4 shadow-sm md:p-5">
          <div className="space-y-4 text-sm leading-relaxed text-slate-700">
            <div>
              <p className="inline-flex items-center gap-2 text-sm font-semibold uppercase tracking-widest text-slate-900">
        ...
        <section className="quote-print-card quote-print-feature-grid grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <article className="rounded-2xl border border-slate-200/85 bg-white/92 p-4 shadow-sm">
        ...
        <section className="quote-print-actions rounded-2xl border border-slate-200/85 bg-white/92 p-4 shadow-sm md:p-5">
        ...
        <footer className="quote-print-card rounded-2xl border border-slate-200/85 bg-white/92 p-4 shadow-sm md:p-5">
