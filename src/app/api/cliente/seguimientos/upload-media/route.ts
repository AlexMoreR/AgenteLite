...
export async function POST(request: Request) {
  ...
  if (!access || !canAccessClientModule(access, "seguimientos")) {
  ...
  const uploadDir = path.join(process.cwd(), "public", "uploads", "seguimientos-media");
  ...
  const relativeUrl = `/uploads/seguimientos-media/${fileName}`;
